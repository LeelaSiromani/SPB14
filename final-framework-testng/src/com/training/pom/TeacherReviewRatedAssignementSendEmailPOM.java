...
public class TeacherReviewRatedAssignementSendEmailPOM {
	
	private WebDriver driver; 
	
	public TeacherReviewRatedAssignementSendEmailPOM(WebDriver driver) {
		this.driver = driver; 
	...
	private WebElement SendMailToStudent; 
	...
	public void clickSendMailToStudent() {
		this.SendMailToStudent.click(); 
		}
